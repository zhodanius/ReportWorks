...
#ifdef WIN32
 #ifdef MULTITHREADED
#define SZ_IMGLIB 			_T( "ACCUIMR5.DLL" )
 #else
#define SZ_IMGLIB 			_T( "ACCUISR5.DLL" )
 #endif
#else
#define SZ_IMGLIB 			_T( "ACCUSFT5.DLL" )
#endif

#define SZ_IMGLOAD 			_T( "IMG_decompress_bitmap" )
#define SZ_IMGLOADFD		_T( "IMG_decompress_bitmap_fd" )
#define SZ_IMGSAVE 			_T( "IMG_save_bitmap" )
#define SZ_IMGDISPLAY		_T( "IMG_display_bitmap" )
#define SZ_IMGPALETTE		_T( "IMG_bitmap_palette" )
#define SZ_IMGDELETE		_T( "IMG_delete_bitmap" )
#define SZ_IMGINFO 			_T( "IMG_bitmap_info" )
#define SZ_IMGSETCROP		_T( "IMG_set_croprect" )
#define SZ_IMGDIBTODDB		_T( "IMG_dib_to_ddb" )
#define SZ_IMGDISPLAYDDB 	_T( "IMG_display_ddb" )
#define SZ_IMGMEDIANCUT		_T( "IMG_mediancut_color" )
#define SZ_IMGDIFFUSION		_T( "IMG_diffusion_color" )
#define SZ_IMGCREATE		_T( "IMG_create_handle" )
#define SZ_IMGCREATEDDB		_T( "IMG_create_handle_ddb" )
#define SZ_IMGPRINT			_T( "IMG_print_bitmap" )
#define SZ_IMGPRINTFAST		_T( "IMG_print_bitmap_fast" )

#define SZ_PWIMGFUNCS		_T ( "pwImgFuncs" )
