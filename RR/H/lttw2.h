...
typedef L_VOID (pEXT_CALLBACK LTWAINACQUIRECALLBACK)(HTWAINSESSION hSession, L_INT nPage, L_CHAR L_FAR * pszFileName, L_BOOL bFinishScan, L_VOID *pUserData);
...
L_INT EXT_FUNCTION L_TwainAcquireList (HTWAINSESSION hSession, HBITMAPLIST hBitmap, L_CHAR * lpszTemplateFile, L_UINT uFlags);
L_INT EXT_FUNCTION L_TwainAcquire (HTWAINSESSION hSession, pBITMAPHANDLE pBitmap, LTWAINBITMAPCALLBACK pfnCallBack, L_UINT uFlags, L_CHAR * lpszTemplateFile, L_VOID * pUserData);
...
L_INT EXT_FUNCTION L_TwainTemplateDlg (HTWAINSESSION hSession, L_CHAR * lpszTemplateFile, LTWAINSAVECAPCALLBACK pfnCallBack, LTWAINSAVEERRORCALLBACK pfnErCallBack, L_VOID * pUserData);
L_INT EXT_FUNCTION L_TwainOpenTemplateFile (HTWAINSESSION hSession, HTWAINTEMPLATEFILE * phFile, L_CHAR * lpszTemplateFile, L_UINT uAccess);
