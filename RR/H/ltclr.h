...
typedef struct
{
   ...
   L_TCHAR        sInputProfile[MAX_PATH]; /*  optional input profile                                        */
   L_TCHAR        sOutputProfile[MAX_PATH];/*  optional output profile                                       */
   L_TCHAR        sDstInputTable[MAX_PATH];/*  optional Dst image for emulation                              */
...
L_INT EXT_FUNCTION L_ClrConvertDirectToBitmap(L_INT nSrcFormat,
                                              L_INT nDstFormat,
                                              L_UCHAR *pSrcBuf,
...
L_INT EXT_FUNCTION L_ClrConvertToBitmap(HANDLE ClrHandle,
                                        L_UCHAR *pSrcBuf, 
                                        BITMAPHANDLE *pBitmap,
                                        L_INT nWidth,
                                        L_INT nHeight,
...
L_INT EXT_FUNCTION L_ClrDlg(L_INT  nDlg,
                            HANDLE hWnd,
                            HANDLE *pClrHandle, 
                            LPCONVERSION_PARAMS pParams);
